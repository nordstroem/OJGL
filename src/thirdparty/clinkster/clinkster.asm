...
; OJGL local change: the Clinkster_GetInstrumentTrigger body (near the bottom of this file) is
; only assembled when CLINKSTER_GENERATE_TIMING_DATA is set, so exporting it unconditionally
; left an undefined external at link time. Gate the exports on the same flag.
