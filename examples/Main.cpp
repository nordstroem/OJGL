#include "EmbeddedShaders.h" // generated by ojgl_add_demo(): the selected demo's shaders
#include "FreeCameraController.h"
#include "SelectedDemo.h" // generated by ojgl_add_demo(): provides ojgl::createSelectedDemo()
...
#ifdef _DEBUG
    for (const auto& [path, diskPath] : resources::shaderDiskPaths)
        ShaderReader::registerDiskPath(path, diskPath);
#endif

    const auto demo = createSelectedDemo();
